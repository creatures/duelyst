...
// NOTE:
//
// Uses the list of assets found in app/data/assets to retrieve image and
// plist files for each asset. Once downloaded the plist file is parsed to
// determine where the initial idle animation image can be found. That image
// is then cropped and saved to app/images/avatar.
//
// Run the script via `node ./lib/imagery.js`
//
